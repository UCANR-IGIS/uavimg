...
## Add markers
m_pts <- m_pts %>% addCircleMarkers(lng=params$pts@data$gps_long, lat=params$pts@data$gps_lat, radius=3, stroke=FALSE, fillColor=params$col, fillOpacity=1)
 ...
 * image thumbnails
 * total acres covered
 * Horizonal speed at time of acquisition
 * centroids and footprints combined in one map
